...
LABEL authors="Phil Palmer, Christina Chatzipantsiou" \
      description="Docker image containing all software requirements for the biobank-gwas pipeline"
...
ENV PATH /opt/conda/envs/biobank-gwas-1.0dev/bin:$PATH

# Dump the details of the installed packages to a file for posterity
RUN conda env export --name biobank-gwas-1.0dev > biobank-gwas-1.0dev.yml
