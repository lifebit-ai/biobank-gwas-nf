...
nextflow run main.nf \
  --plinkFile "s3://lifebit-featured-datasets/pipelines/biobank-gwas/testdata/sampleA.{bed,bim,fam}" \
  ...
  --case_group "NOSE" \
  --vcfsList "s3://lifebit-featured-datasets/pipelines/biobank-gwas/testdata/vcfs.csv" \
  --outdir results/ \
  --outprefix test_ 
```
